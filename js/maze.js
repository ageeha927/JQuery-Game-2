$(document).ready(function() {
    ...
    var music = new Audio("./audio/level1.mp3");
    ...
    var playerY = 80; // Adjusted player starting position

    // Timer countdown
    var timeLeft = 60; // 45 seconds
    var timerInterval;
    ...
    function movePlayer(dx, dy, imageUrl) {
        ...
        if (newX >= 0 && newX < mazeWidth && newY >= 0 && newY < mazeHeight) {
            ...
            if(playerX === 720 && playerY === 720){
                clearInterval(timerInterval); // Stop the timer when the player wins
                alert("Congratulations! You beat the maze!");
                calculateScore()
    ...
    $(document).keydown(function(e) {
        ...
        function calculateScore() {
            var timeTaken = 60 - timeLeft; // Calculate time taken
