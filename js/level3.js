$(document).ready(function() {
    ...
    var music = new Audio("./audio/level3.mp3");
    ...
    var playerX = 680; // Adjusted player starting position
    var playerY = 360; // Adjusted player starting position
    ...
    function movePlayer(dx, dy, imageUrl) {
        ...
        if (newX >= 0 && newX < mazeWidth && newY >= 0 && newY < mazeHeight) {
            ...
            if(playerX === 40 && playerY === 560){
                clearInterval(timerInterval); // Stop the timer when the player wins
                alert("Congratulations! You beat all 3 levels!");
                calculateScore()
    ...
    $(document).keydown(function(e) {
        ...
        function calculateScore() {
            var timeTaken = 20 - timeLeft; // Calculate time taken
